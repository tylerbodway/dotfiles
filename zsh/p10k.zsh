# Generated by Powerlevel10k configuration wizard on 2024-07-22 at 10:33 CDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 37096.
# Wizard options: nerdfont-v3 + powerline, large icons, unicode, lean_8colors, 12h time,
# 2 lines, dotted, left frame, green-ornaments, sparse, many icons, concise,
