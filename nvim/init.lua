...
-- [[ Setting options ]] -- see `:help vim.opt`, and `:help option-list`d
...
-- [[ Plugin Manager ]] -- see `:help lazy.nvim.txt` or https://github.com/folke/lazy.nvim
...
-- [[ Configure and install plugins ]] -- see :Lazy

require('lazy').setup({
  -- NOTE: Plugins can be added with a link, github repo 'owner/repo',
  -- or table with first argument being the link and following keys
  -- being used to configure behavior/loading/etc.
  ...
  -- Show pending keybindings
  {
    ...
    event = 'VimEnter', -- see `:help autocmd-events`
  ...
  -- Fuzzy Finder (files, lsp, etc)
  {
    ...
    config = function()
      -- Learn what Telescope can do with ...
      --  - Insert mode: <c-/>
      --  - Normal mode: ?
  ...
  -- LSP Configuration & Plugins
  {
    ...
    dependencies = {
      ...
      { 'folke/neodev.nvim', opts = {} }, -- configures Lua LSP for Neovim config, runtime, and plugins
    },
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Autocommand to highlight references of word under cursor while resting
          -- also when you move your cursor, the highlights will be cleared.
      ...
      -- LSP servers, see `:help lspconfig-all`
      local servers = {
        -- ls_name = {
        --   cmd = {}           - override default command used to start the server
        --   filetypes = {},    - override default list of associated filetypes for the server
        --   capabilities = {}, - override fields in capabilities which can be used to disable certain LSP features
        --   settings = {},     - override default settings when initializing the server
        -- }
        css_variables = {},
        emmet_ls = {},
        gopls = {},
